...
- ระบบควรเก็บ order, payment, และ item ไว้เพื่อ audit แทนการลบ hard delete
- ควรบันทึกเหตุผลการยกเลิก เช่น `cancelReason` เมื่อ client ส่งมาด้วย
...
- การยกเลิก item บางรายการต้องไม่ทำให้ order total/report ยังนับ item ที่ถูก `CANCELLED`
- การยกเลิกซ้ำต้องถูกป้องกันเพื่อไม่ให้ reverse stock ซ้ำ
